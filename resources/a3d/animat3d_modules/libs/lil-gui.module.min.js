...
const s = {isPrimitive: !0, match: t => "string" == typeof t, fromHexString: i, toHexString: i}, r = {
    isPrimitive: !0,
    match: t => "number" == typeof t,
    fromHexString: t => parseInt(t.substring(1), 16),
    toHexString: t => "#" + t.toString(16).padStart(6, 0)
}, n = {
    isPrimitive: !1, match: Array.isArray, fromHexString(t, e, i = 1) {
    ...
    isPrimitive: !1, match: t => Object(t) === t, fromHexString(t, e, i = 1) {
        const s = r.fromHexString(t);
        e.r = (s >> 16 & 255) / 255 * i, e.g = (s >> 8 & 255) / 255 * i, e.b = (255 & s) / 255 * i
    }, toHexString: ({r: t, g: e, b: i}, s = 1) => r.toHexString(t * (s = 255 / s) << 16 ^ e * s << 8 ^ i * s << 0)
}, o = [s, r, n, l];
...
class d extends t {
    ...
    _initSlider() {
        ...
        const l = e => {
            if (n) {
                const i = e.touches[0].clientX - s, a = e.touches[0].clientY - r;
        ...
        this.$slider.addEventListener("touchstart", e => {
            e.touches.length > 1 || (this._hasScrollBar ? (s = e.touches[0].clientX, r = e.touches[0].clientY, n = !0) : (e.preventDefault(), t(e.touches[0].clientX), this._setActiveStyle(!0), n = !1), window.addEventListener("touchmove", l, {passive: !1}), window.addEventListener("touchend", o))
        });
    ...
    _clamp(t) {
        const e = this._hasMin ? this._min : -1 / 0, i = this._hasMax ? this._max : 1 / 0;
